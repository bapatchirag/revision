...
This is the fallback for any platform without a prebuilt binary. Installing at a
published tag produces a release build, which does check for
[self-updates](/operations/updating-revision/); installing at an untagged commit does
